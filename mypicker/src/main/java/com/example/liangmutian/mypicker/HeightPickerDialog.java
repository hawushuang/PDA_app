...
public class HeightPickerDialog extends Dialog {
    ...
    private static int MIN_YEAR = 130;
    private static int MAX_YEAR = 230;
    private Params params;


    public HeightPickerDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(HeightPickerDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final HeightPickerDialog.Params params;
        ...
        public Builder(Context context) {
            ...
            params = new HeightPickerDialog.Params();
        }
        ...
        public HeightPickerDialog create() {
            final HeightPickerDialog dialog = new HeightPickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            View view = LayoutInflater.from(context).inflate(R.layout.layout_picker_height, null);
