...
public class WeightPickerDialog extends Dialog {
    ...
    private static int MIN_YEAR = 30;
    private static int MAX_YEAR = 130;
    private Params params;


    public WeightPickerDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(WeightPickerDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final WeightPickerDialog.Params params;
        ...
        public Builder(Context context) {
            ...
            params = new WeightPickerDialog.Params();
        }
        ...
        public WeightPickerDialog create() {
            final WeightPickerDialog dialog = new WeightPickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            View view = LayoutInflater.from(context).inflate(R.layout.layout_picker_weight, null);
