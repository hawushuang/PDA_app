package com.microtechmd.pda_app.widget.myswitchbutton;
 ...
 * @author luke
 */
public class LukeSwitchButton extends View {
    ...
    private LukeSwitchButton(Context context) {
        super(context);
    }

    public LukeSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setup(attrs);
    }

    public LukeSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(attrs);
    }
    ...
    public void setup(AttributeSet attrs) {
        ...
        offBorderColor = typedArray.getColor(R.styleable.SwitchButton_tbOffBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.SwitchButton_tbOnColor, onColor);
        spotColor = typedArray.getColor(R.styleable.SwitchButton_tbSpotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.SwitchButton_tbOffColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.SwitchButton_tbBorderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.SwitchButton_tbAnimate, defaultAnimate);
        isDefaultOn = typedArray.getBoolean(R.styleable.SwitchButton_tbAsDefaultOn, isDefaultOn);
        typedArray.recycle();
