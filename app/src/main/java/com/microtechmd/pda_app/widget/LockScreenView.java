...
public class LockScreenView extends android.support.v7.widget.AppCompatImageView {
     ...
     * �������������»����λ��
     *
     * @param completePercent ���黬���İٷֱȣ�ֻ�е�E_Action == E_Moveʱ�ò�����Ч����Чʱ���鴫��-1
     * @param E_Action        ���ڱ�ʾ��Ϊ����MotionEvent��ACTION_XXX��Ӧ
     * @author qian.zhou
     ...
     * @param x           Touch�¼��е�x���ֵ
     * @param y           Touch�¼��е�y���ֵ
     * @param eventAction Touch�¼��е�Touch����
     * @author qian.zhou
     * @version 1.1.1, 2012-12-25
     * @since 1.1.1, 2012-12-25
     */
