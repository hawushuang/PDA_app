...
public class WidgetSettingItem extends RelativeLayout {
    ...
    public WidgetSettingItem(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            setIconLef(typedArray
                    .getResourceId(R.styleable.WidgetSettingItem_iconLeft, 0));
            setIconRight(typedArray
                    .getResourceId(R.styleable.WidgetSettingItem_iconRight, 0));
        } finally {
            typedArray.recycle();
        }
    }
    ...
    public void setIconLef(int icon) {
        if (icon != 0) {
            TextView textDrawable = findViewById(R.id.tv_item_name);
    ...
    private void setIconRight(int resourceId) {
        ImageView iv_right = findViewById(R.id.iv_icon_right);
        if (resourceId == 0) {
