...
import com.microtechmd.pda_app.util.FormatterUtil;
import com.microtechmd.pda_app.util.SpObjectListSaveUtil;
import com.microtechmd.pda_app.widget.repo.BubbleSeekBar;
...
public class FragmentCombinedGraph extends FragmentBase
    ...
    private List<DbHistory> mDblist;
    ...
    private BubbleSeekBar glucose_seek_bar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final Runnable runnable = new Runnable() {
            @Override
            public void run() {
                glucose_seek_bar.setVisibility(View.GONE);
            }
        };
        glucose_seek_bar = mRootView.findViewById(R.id.glucose_seek_bar);
        mChart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                glucose_seek_bar.setVisibility(View.VISIBLE);
//                handler.removeCallbacks(runnable);
//                handler.postDelayed(runnable, 3000);
            }
        });
        glucose_seek_bar.setOnProgressChangedListener(new BubbleSeekBar.OnProgressChangedListener() {
            @Override
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case 1:
                        ...
                        for (DbHistory dbHistory : mDblist) {
                            dataListAll.add(getHistory(dbHistory));
                        }
                        if (applicationPDA != null) {
...
// draw LINE behind SCATTER
    ...
    private LineData generateLineData() {
        int mHyper = (int) SPUtils.get(getActivity(), HIGHGLUCOSE_SAVED, HIGH_DEFAULT);
        int mHypo = (int) SPUtils.get(getActivity(), LOWGLUCOSE_SAVED, LOW_DEFAULT);
        ;
        DateTime todayDateTime = getTodayDateTime();
        ...
        if ((message.getSourcePort() == ParameterGlobal.PORT_MONITOR) &&
            ...
            if ((message
                ...
                for (int i = 0; i < dataList.getCount(); i++) {
                    ...
                    dataListCash.add(new History(dataList.getData(i)));
                }
