...
import com.microtechmd.pda_app.util.AndroidSystemInfoUtil;
...
public class HistoryLogActivity extends ActivityPDA {
...
//                }
    ...
    private class HistoryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                historyListView = new HistoryView(HistoryLogActivity.this);
            }
            ...
            historyListView.setView(dateTime.getCalendar().
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_history_log);
