...
public class RegistrationPhoneActivity extends ActivityPDA {
    ...
    private void initClick() {
        ...
        tv_tousername.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RegistrationPhoneActivity.this,
    ...
    private void getSMSCode(String action) {
        try {
            ...
            OkHttpUtils
                    ...
                    .content(json)
                    .build()
                    .execute(new MyStringCallback(RegistrationPhoneActivity.this) {
                        @Override
                    ...
                    .execute(new MyStringCallback(RegistrationPhoneActivity.this) {
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            if (authorModel.getInfo().getCode() != 100000) {
                                ...
                                SPUtils.put(RegistrationPhoneActivity.this, StringConstant.FIRST_LOGIN, false);
                                if (firstLoginFlag) {
                                    Intent intent = new Intent(RegistrationPhoneActivity.this,
